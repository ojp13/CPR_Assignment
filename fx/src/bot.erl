...
waiting(Balances, Lowest_Balance, Transactions, Diversification_Factor, Risk_Appetite, Fx_Node) ->
    % io:format("Current Balances: ~p ~n", [Balances]),
    % io:format("Current Transactions: ~p ~n", [Transactions]),
    receive 
        ...
        {add_to_transactions, Transaction_Id, Type, Pair, Volume} ->
            Updated_Transactions = add_transaction(Transaction_Id, Type, Pair, Volume, Transactions),
...
add_transaction(Transaction_Id, Type, Pair, Volume, Transactions) ->
    [{Transaction_Id, Type, Pair, Volume} | add_transaction(Transactions)].
